...
import { ThemeSelectorAdmin } from '../components/ThemeSelectorAdmin';
        ...
        {activeMainTab === 'tema' && (
          <div className="tab-content">
            <div style={{ maxWidth: '600px', margin: '0 auto' }}>
              ...
              <p style={{ color: '#666', marginBottom: '2rem' }}>Velg tema for overdrevne effekter på Min Side og Chat!</p>
              <ThemeSelectorAdmin />
            </div>
          </div>
        )}
